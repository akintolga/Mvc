...
namespace Microsoft.AspNetCore.Mvc.ViewFeatures
{
    ...
    public class CookieTempDataProvider : ITempDataProvider
    {
        ...
        public IDictionary<string, object> LoadTempData(HttpContext context)
        {
            ...
            {
                var base64AndUrlEncodedBytes = _chunkingCookieManager.GetRequestCookie(context, CookieName);
                if (!string.IsNullOrEmpty(base64AndUrlEncodedBytes))
                {
                    var protectedData = Base64UrlTextEncoder.Decode(base64AndUrlEncodedBytes);
        ...
        public void SaveTempData(HttpContext context, IDictionary<string, object> values)
        {
            ...
            if (hasValues)
            {
                ...
                var base64AndUrlEncodedBytes = Base64UrlTextEncoder.Encode(bytes);
                _chunkingCookieManager.AppendResponseCookie(context, CookieName, base64AndUrlEncodedBytes, cookieOptions);
            }
            else
            {
